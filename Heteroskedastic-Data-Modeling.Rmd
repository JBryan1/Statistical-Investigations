...
dataGen = function(b, n, p, a, h ){
  ...
  matrix(data = c(y,t,X[,2:p]), nrow = n, ncol = p+1)
}
...
#works
data = dataGenMC(b = betas, n = 300, p = 20, a=10, h =5, cor = 20)
round(GQ.function(lm = lm(data[,1] ~ data[,-1]), time = data[,2], X = data[,-c(1,2)]),3)
